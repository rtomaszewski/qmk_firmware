...
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
          xxxxxxx,            _______,          RSFT(KC_B),        RSFT(KC_K),        RSFT(KC_F),           _______ ,         _______,          
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
        RSFT(KC_TAB),         RSFT(KC_R),       RSFT(KC_S),        RSFT(KC_T),        RSFT(KC_H),          RSFT(KC_D),       /* - */        
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
          _______ ,           RSFT(KC_Q),       RSFT(KC_J),        RSFT(KC_G),        RSFT(KC_C),          RSFT(KC_P),        _______,          
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
...
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
           _______,            _______,           RSFT(KC_L),          RSFT(KC_V),       RSFT(KC_U),        _______ ,           xxxxxxx,          
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
          /* - */              RSFT(KC_M),        RSFT(KC_N),          RSFT(KC_A),       RSFT(KC_I),        RSFT(KC_O),         RSFT(KC_ENTER),      
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
           _______,            _______,           RSFT(KC_W),          RSFT(KC_Y),       RSFT(KC_X),        RSFT(KC_Z),         _______, 
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
                                                   xxxxxxx,         xxxxxxx,            xxxxxxx,            xxxxxxx,           xxxxxxx,      
//                                         `-------------------+-------------------+-------------------+-------------------+---------------------'
