...
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
            xxxxxxx,       TG(L_ARROWS),         C_S_T(KC_C),   OSL(BASE_RADO2_LEFT),    A_C_T(KC_F),        LCTL(KC_S) ,         KC_PGUP,          
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
...
// |-------------------+-------------------+----ct---------------+-------------------+-------------------+-------------------+---------------------|
            xxxxxxx,       OSL(L_F1) ,          OSL(OTHERS),      TD(TD_KEY_COPY),    TD(TD_KEY_PASTE),        KC_B,            KC_PGDOWN,          
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
...
// `-------------------+-------------------+-------------------+-------------------+-------------------'
 ...
 //                                                                                                   -------------------+-------------------|
                                                                                                             /* - */           xxxxxxx,       
 //                                                                               |-------------------+------------------+-------------------|
                                                                                   LT(L_ARROWS2,KC_E) ,       KC_SPACE,       xxxxxxx,       
 //                                                                               `-------------------+------------------+-------------------'
...
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
           _______,           _______,           KC_W,               KC_Y,               TG(L_ARROWS),   OSL(L_ARROWS_BASH),     xxxxxxx,          
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
...
//                                         `-------------------+-------------------+-------------------+-------------------+---------------------'
 ...
 //       -------------------+-------------------|
                xxxxxxx,             /* - */
 //       |-------------------+------------------+-------------------|
               xxxxxxx,           KC_BSPACE,      LT(L_ARROWS_BASH, KC_SPACE)
 //       `-------------------+------------------+-------------------'
),
