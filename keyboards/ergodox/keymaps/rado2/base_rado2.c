...
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
      xxxxxxx,                 KC_Q,            KC_B,          OSL(BASE_RADO2_LEFT),     A_C_T(KC_F),        LCTL(KC_S) ,         KC_PGUP,          
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
LT(BASE_RADO2_RIGHT,KC_TAB),   KC_R,            CTL_T(KC_S),        LT(L_F1,KC_T),       ALT_T(KC_H),           KC_D ,              /* - */        
// |-------------------+-------------------+----ct---------------+-------------------+-------------------+-------------------+---------------------|
    OSL(L_NUMBERS) ,      OSL(L_SHIFT),    TO(L_ARROWS_BASH),      TD(TD_KEY_COPY),    TD(TD_KEY_PASTE),   LGUI_T(KC_P),        KC_PGDOWN,          
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
...
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
           _______,            _______,       A_C_T(KC_L),     OSL(BASE_RADO2_RIGHT),       KC_U,        _______,         xxxxxxx,          
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
