...
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
      xxxxxxx,                 KC_Q,            KC_P,          OSL(BASE_RADO2_LEFT),     A_C_T(KC_F),        LCTL(KC_S) ,         KC_PGUP,          
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
LT(BASE_RADO2_RIGHT,KC_TAB),   KC_R,            CTL_T(KC_S),        LT(L_F1,KC_T),       ALT_T(KC_H),           KC_D ,              /* - */        
// |-------------------+-------------------+----ct---------------+-------------------+-------------------+-------------------+---------------------|
    OSL(L_NUMBERS) ,      OSL(L_SHIFT),    TO(L_ARROWS_BASH),      TD(TD_KEY_COPY),    TD(TD_KEY_PASTE),   LGUI_T(KC_B),        KC_PGDOWN,          
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
