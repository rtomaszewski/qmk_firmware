...
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
    OSL(L_NUMBERS) ,        F(F_SHIFT),         F(F_CONTROL_L),         TD(TD_KEY_COPY),    TD(TD_KEY_PASTE),   LGUI_T(KC_P),        KC_PGDOWN,          
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
...
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
           _______,            _______,       A_C_T(KC_L),          F(F_RIGHT),             KC_U,           OSM(MOD_LALT),     xxxxxxx,          
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
