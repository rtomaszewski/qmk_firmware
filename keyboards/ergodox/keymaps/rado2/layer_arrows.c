...
// ,-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------.
     TO(BASE_RADO2),          KC_4,           xxxxxxx,           xxxxxxx,              xxxxxxx,           xxxxxxx,         xxxxxxx,          
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
            KC_LGUI,          _______ ,          LCTL(KC_Y),        _______,            _______ ,           LCTL(KC_S) ,      KC_LALT,     
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
            KC_TAB,           LCTL(KC_A) ,       LCTL(KC_Z) ,    LCTL(KC_C),          LCTL(KC_V) ,        LCTL(KC_X),          /* - */     
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
            xxxxxxx,          KC_LSFT,           _______,        TG(L_ARROWS2),         LCTL(KC_S) ,           _______ ,       KC_LCTL,     
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
