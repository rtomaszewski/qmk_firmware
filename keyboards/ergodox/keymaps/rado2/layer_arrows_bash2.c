...
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
            _______,           _______,          _______,            LCTL(KC_C),         _______ ,         _______,        /* - */     
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
            xxxxxxx,           _______,    LCTL(LSFT(KC_MINUS)),  LSFT(KC_INSERT) ,     LCTL(KC_Y) ,      _______,         xxxxxxx,     
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
...
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
          /* - */             LCTL(KC_U)  ,    LALT(KC_B),           KC_DOWN  ,        LALT(KC_F) ,        LCTL(KC_K) ,       _______ ,     
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
