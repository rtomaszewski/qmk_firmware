...
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
            _______,       LCTL(KC_R),          _______,           _______,             _______ ,         _______,        /* - */     
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
            xxxxxxx,        _______ ,    LCTL(LSFT(KC_MINUS)),     LCTL(KC_C),        LSFT(KC_INSERT),      LCTL(KC_Y),         xxxxxxx,     
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
...
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
          /* - */              LCTL(KC_A) ,    LALT(KC_B),           KC_DOWN  ,        LALT(KC_F) ,         LCTL(KC_E) ,     TO(BASE_RADO2) ,     
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
           xxxxxxx,           LCTL(KC_U) ,      _______ ,             _______ ,           _______ ,        LCTL(KC_K)  ,      xxxxxxx,
// |-------------------+-------------------+-------------------+-------------------+-------------------+-------------------+---------------------|
